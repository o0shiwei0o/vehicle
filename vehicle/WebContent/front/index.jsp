...
<div class="indexConPh left">
 ...
 <!--图片滚动部分-->
        <div class="conServerCon left">
            ...
            <div class="scrollDiv">
                <ul class="scrollUl">
                    <li><a href="#"><p><img src="img/1.jpg"> </p>
                    <p>酒后驾驶</p></a> </li>
                    <li><a href="#"><p><img src="img/2.gif"> </p>
                        <p>超速驾驶</p></a> </li>
                    <li><a href="#"><p><img src="img/3.gif"> </p>
                        <p>斑马线前未减速</p></a> </li>
                    <li><a href="#"><p><img src="img/4.gif"> </p>
                        <p>高速违规停车</p></a> </li>
                    <li><a href="#"><p><img src="img/5.jpg"> </p>
                        <p>危险驾驶</p></a> </li>
                    <li><a href="#"><p><img src="img/6.gif"> </p>
                        <p>危险驾驶</p></a> </li>
                </ul>
            </div>
        </div>
